<template>
    <form action="회원가입_처리_페이지_URL" method="POST" enctype="multipart/form-data">
        <div class="form-container">
            ...
            <button type="submit" class="submit-button"><RouterLink :to="{ name: 'joinProfile'}">다음</RouterLink></button>
        </div>
    </form>
</template>
...
.form-container {
    ...
    align-items: flex-start; /* 내부 콘텐츠는 왼쪽 정렬 */
    background: #ffffff;
    padding: 100px;
    width: 600px;
    max-width: 800px;
